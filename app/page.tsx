...
import { RoiAICard } from "@/components/ui/RoiAICard";
import { MiniChatbot } from "@/components/ui/MiniChatbot";
...
export default function HomePage() {
  return (
    <div className="space-y-20 lg:space-y-24">
      ...
      <section className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-indigo-50 to-sky-50 p-6 shadow-sm shadow-slate-100 dark:border-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:shadow-[0_18px_45px_rgba(0,0,0,0.65)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-2">
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50 sm:text-3xl">
              Prouvez la valeur en quelques secondes
            </h2>
            <p className="text-sm text-slate-600 dark:text-slate-300">
              Une page Démo IA pensée conversion : audit SEO, qualification et ROI. Gratuit, sans inscription.
            </p>
          </div>
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          <Card eyebrow="SEO" title="Audit SEO en 60 secondes" description="Collez une URL : score, 3 priorités, quick wins et prochaine étape." />
          <Card eyebrow="Assistant" title="Chatbot de qualification" description="Questions courtes → redirection vers audit / contact / tarifications." />
          <Card eyebrow="ROI" title="Économies & ROI (3/6/12 mois)" description="Estimation rapide basée sur votre équipe, tâches et temps perdu." />
        </div>
      </section>
